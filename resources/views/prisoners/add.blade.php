<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Početna-Zatvorenici-Dodavanje') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-2">
                    <form method="POST" action="{{ route('store_prisoner') }}">
                        @csrf
                        <div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="DOB" class="block mt-1 w-full" type="date" name="DOB" required autofocus />
                        </div>
                        <div class="mt-4">
